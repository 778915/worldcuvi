...
const PremiumUserBadge = ({ className = '', size = 'sm', onClick }: PremiumUserBadgeProps) => {
  const sizeClasses = {
    sm: 'w-[18px] h-[18px]',
    md: 'w-[24px] h-[24px]',
    lg: 'w-[32px] h-[32px]',
  ...
  return (
    <div 
      className={`premium-badge group ${sizeClasses} ${className}`}
      onClick={onClick}
    >
      <svg className="crown-icon" viewBox="0 0 576 512">
